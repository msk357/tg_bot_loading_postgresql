...
TABLES_LIST_DB: dict[str] = {
                    ...
                    'vmr': {
                        ...
                        'percent_to_int': [
                            '1. Решение вопроса',
                            '4. ПРОДВИЖЕНИЕ ДОПОЛНИТЕЛЬНОЙ ПРОДАЖИ',
                            '5. ПРОДВИЖЕНИЕ УСЛУГ ФИКСИРОВАННОЙ СВЯЗИ И АО РОСТЕЛЕКОМ',
                            'Итоговая оценка'
                        ],
                        'columns_name_csv': [
                            'POS ID',
...
CURRENT_PK_STR: list[str] = [
    ...
    'г.Москва, Мясницкая,30/1/2, стр.2 *Теле2*',
