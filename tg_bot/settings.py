...
В модуле хранятся секретные переменные из .env и основные глобальные переменные.
"""
import os
...
columns_name_csv - названия столбцов CSV-файла, которые необходимо загрузить в таблицу DB.
